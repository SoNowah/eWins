        ...
        <header>
            <nav class="nav">
                ...
                <ul class="nav__links">
                    ...
                    <li class="nav__links__element"><a class="a__link" href="connexion.php">Connexion</a></li>
                    <li class="nav__links__element"><a class="a__link" href="inscription.php">Inscription</a></li>
                </ul>
            </nav>
        </header>